...
##Size and distance: Complete Pooling using OLS Regression
```{r, echo = FALSE, fig.width = 9, fig.height = 6}
#Complete Pooling: Fit a single model to all data points
...
##Size and distance: No Pooling using OLS Regression
...
##Figure 10: Stats and plot of Size and distance rmcorr overall (ignoring factor levels) 
```{r, echo=FALSE, fig.width = 9, fig.height = 6}
#Seperate rmcorr on each actual distance (factor level)
...
#Null + fixed effect for perceived distance
Model1 <-lmer(Emmert_distance_meters~ Perceived_dist + (1|Participant), data =Size_distance, REML = FALSE)

#Model 1 + fixed effect for actual distance (crossed with perceived distance)
Model2 <-lmer(Emmert_distance_meters~ Actual_dist_meters * Perceived_dist + (1|Participant), data =Size_distance, REML = FALSE)

#Model Comparison
anova(NullModel, Model1, Model2)
...
ModelTable<-aictab(SizeDistModels, modnames = c("Null", "Model 1", "Model 2")) 
ModelTable
evidence(ModelTable)

#Model 3:  RE slopes for perceived dist. Does not converge with defaults. 
#Model3 <-lmer(Emmert_distance_meters~ Actual_dist_meters * Perceived_dist + (1 + Perceived_dist |Participant), data =Size_distance, REML = #FALSE)
