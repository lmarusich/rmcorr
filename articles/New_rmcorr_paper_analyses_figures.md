...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-3-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-4-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-5-1.png)
...
{
    pwr::pwr.r.test(n = ((N)*(k-1))+1, r = effectsizer, sig.level = sig) 
...
k<-c(3, 5, 10, 20) 
nvals <- seq(6, 300)
powPearsonSmall <- sapply(nvals, function (x) pwr::pwr.r.test(n=x, r=0.1)$power)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-6-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-7-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-8-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-9-1.png)
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-10-1.png)
...
#> .sig02       0.00000000 0.16222660
#> .sig03      -1.00000000 1.00000000
...
![](New_rmcorr_paper_analyses_figures_files/figure-html/unnamed-chunk-11-1.png)
