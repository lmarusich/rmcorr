...
*Note* power is just slighty different in than the same calculation in R, which uses an approximation.
...
In this example, we compare *r*<sub>*rm*</sub> values from two distinct datasets. That is, the datasets are completely independent -- they do  not have the same participants. This is a nonsense example because the two datasets are from completely different experimental design that do not have common measures. 
<br>
<br>
...
#### Correlated/Dependent/Overlapping Correlations
```{r}
...
### Non-Linearity
Rmcorr fits a linear model. If the data are non-linear, we recommend using multilevel modeling instead. 
...
### 1) Shiny: Web App and Standalone with a graphical interface 
- <a href="https://lmarusich.shinyapps.io/shiny_rmcorr/">Web App</a>

- <a href="https://github.com/lmarusich/rmcorrShiny">Shiny Source Code and Information on Running Standalone</a> 
