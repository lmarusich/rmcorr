...
Power can be calculated using the \emph{power.rmcorr} function in the paper vignette. This function modifies pwr.r.test from the <a href="https://cran.r-project.org/web/packages/pwr/index.html">pwr</a> package to use the rmcorr degrees of freedom.
<br> 
...
and/or highly unbalanced data. This is nicely illustrated in simulations by Dr. Martas Karass: 
<br>
