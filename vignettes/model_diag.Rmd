...
How much do violations of the above four assumptions matter? It depends. General Linear Model (GLM) is typically robust to deviations from the above assumptions, but severe violations may produce misleading results [@gelman2020regression]. Also, the reason(s) for violations can matter: "Violations of assumptions may result from problems in the dataset, the use of an incorrect regression model, or both" [@cohen2013applied, p. ???].  